    ...
    <header className="p-6 px-8 border-b-[1.5px] border-gray-400">
      <nav className="flex items-center  mx-auto">
        ...
        <div className="flex items-center gap-6 justify-between">
          <button className="rounded-full border-[1.5px] hover:bg-purple-500/10 duration-200 ease-out hover:scale-105 border-purple-500 text-purple-600 py-2 px-3">
            Share a new video
          </button>
          <a href="/wallet">
            <FaWallet className="h-6 w-6 text-gray-400 hover:text-gray-500 hover:scale-110 ease-out duration-300 " />
          </a>
          <a href="/wallet">
            <FaBell className="h-6 w-6 text-gray-400 hover:text-gray-500 hover:scale-110 ease-out duration-300 " />
          </a>
